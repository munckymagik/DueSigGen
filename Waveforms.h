...
#define NUM_WAVEFORMS uint32_t(WaveForm::NumWaveForms)
#define NUM_SAMPLES 120

static int waveformsTable[NUM_WAVEFORMS][NUM_SAMPLES] = {
  // Sin wave
  {
...
inline int get_sample(const WaveForm wave_form, const uint32_t sample_index) {
  return waveformsTable[uint32_t(wave_form)][sample_index];
}
